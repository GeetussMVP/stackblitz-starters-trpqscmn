            ...
            <div className="relative bg-white/10 backdrop-blur-xl rounded-3xl overflow-hidden border border-white/20 shadow-2xl">
              <div className="aspect-[16/9] relative">
                <div className="absolute inset-0 bg-gradient-to-br from-slate-800 to-slate-900 flex items-center justify-center">
                  <div className="text-white/40 text-xl">Team Image</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="relative">
              ...
              <div className="relative bg-white/10 backdrop-blur-xl rounded-3xl overflow-hidden border border-white/20 shadow-2xl">
                <div className="aspect-video relative">
                  <div className="absolute inset-0 bg-gradient-to-br from-slate-800 to-slate-900 flex items-center justify-center">
                    <div className="text-white/40 text-xl">Company History</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div>
              <h2 className="text-5xl md:text-6xl lg:text-7xl font-light text-white mb-6 leading-tight">
                Mūsų{' '}
                <span className="text-teal-300">istorija</span>
              </h2>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="order-2 lg:order-1">
              <h2 className="text-5xl md:text-6xl lg:text-7xl font-light text-white mb-6 leading-tight">
                Mūsų{' '}
                <span className="text-blue-300">vertybės</span>
              </h2>
            ...
            <div className="relative order-1 lg:order-2">
              ...
              <div className="relative bg-white/10 backdrop-blur-xl rounded-3xl overflow-hidden border border-white/20 shadow-2xl">
                <div className="aspect-video relative">
                  <div className="absolute inset-0 bg-gradient-to-br from-slate-800 to-slate-900 flex items-center justify-center">
                    <div className="text-white/40 text-xl">Values Image</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="relative">
            ...
            <div className="relative bg-white/10 backdrop-blur-xl rounded-3xl p-12 border border-white/20 shadow-2xl">
              <h2 className="text-4xl md:text-5xl lg:text-6xl font-light text-white mb-6">
                Pradėkime{' '}
                <span className="text-teal-300">kartu</span>
              </h2>
              <p className="text-xl md:text-2xl text-white/70 font-light mb-8">
                Susisiekite su mumis ir aptarkime jūsų projektą
              </p>
              <button className="bg-teal-500 hover:bg-teal-600 text-white px-8 py-4 rounded-xl text-lg font-light transition-colors">
                Susisiekti
              </button>
            </div>
          </div>
