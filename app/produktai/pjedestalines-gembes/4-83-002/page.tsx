...
const productData = require('@/app/data/pjedestalines-gembes/pjedestalines-gembes.json').products;
...
const getStructuredData = (product: any) => {
  const canonicalUrl = `https://www.dekoratoriai.lt/produktai/pjedestalines-gembes/${product.code}`;
...
export default async function Page() {
  const product = await getProduct('4.83.002');
