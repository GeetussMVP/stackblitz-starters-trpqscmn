...
const productData = require('@/app/data/architravai/architravai.json').products;
...
const getStructuredData = (product: any) => {
  const canonicalUrl = `https://www.dekoratoriai.lt/produktai/architravai/${product.code}`;
...
export default async function Page() {
  const product = await getProduct('4.34.302');
