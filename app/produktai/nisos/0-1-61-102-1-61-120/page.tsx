...
const productData = require('@/app/data/nisos/nisos.json').products;
...
const getStructuredData = (product: any) => {
  const canonicalUrl = `https://www.dekoratoriai.lt/produktai/nisos/${product.code}`;
...
export default async function Page() {
  const product = await getProduct('0-1.61.102-1.61.120');
