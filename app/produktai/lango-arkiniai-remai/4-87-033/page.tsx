...
const productData = require('@/app/data/lango-arkiniai-remai/lango-arkiniai-remai.json').products;
...
const getStructuredData = (product: any) => {
  const canonicalUrl = `https://www.dekoratoriai.lt/produktai/lango-arkiniai-remai/${product.code}`;
...
export default async function Page() {
  const product = await getProduct('4.87.033');
