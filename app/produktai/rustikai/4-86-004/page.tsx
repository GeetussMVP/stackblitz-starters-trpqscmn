...
const productData = require('@/app/data/rustikai/rustikai.json').products;
...
const getStructuredData = (product: any) => {
  const canonicalUrl = `https://www.dekoratoriai.lt/produktai/rustikai/${product.code}`;
...
export default async function Page() {
  const product = await getProduct('4.86.004');
