...
const productData = require('@/app/data/balustrai/balustrai.json').products;
...
const getStructuredData = (product: any) => {
  const canonicalUrl = `https://www.dekoratoriai.lt/produktai/balustrai/${product.code}`;
...
export default async function Page() {
  const product = await getProduct('4.71.101');
