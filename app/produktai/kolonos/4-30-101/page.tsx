...
const productData = require('@/app/data/kolonos/kolonos.json').products;
...
const getStructuredData = (product: any) => {
  const canonicalUrl = `https://www.dekoratoriai.lt/produktai/kolonos/${product.code}`;
...
export default async function Page() {
  const product = await getProduct('4.30.101');
