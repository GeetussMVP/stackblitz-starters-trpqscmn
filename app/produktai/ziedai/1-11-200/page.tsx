...
const productData = require('@/app/data/ziedai/ziedai.json').products;
...
const getStructuredData = (product: any) => {
  const canonicalUrl = `https://www.dekoratoriai.lt/produktai/ziedai/${product.code}`;
...
export default async function Page() {
  const product = await getProduct('1.11.200');
