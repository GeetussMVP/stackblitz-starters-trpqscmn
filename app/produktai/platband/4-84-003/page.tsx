...
const productData = require('@/app/data/platband/platband.json').products;
...
const getStructuredData = (product: any) => {
  const canonicalUrl = `https://www.dekoratoriai.lt/produktai/platband/${product.code}`;
...
export default async function Page() {
  const product = await getProduct('4.84.003');
