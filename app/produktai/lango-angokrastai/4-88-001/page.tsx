...
const productData = require('@/app/data/lango-angokrastai/lango-angokrastai.json').products;
...
const getStructuredData = (product: any) => {
  const canonicalUrl = `https://www.dekoratoriai.lt/produktai/lango-angokrastai/${product.code}`;
...
export default async function Page() {
  const product = await getProduct('4.88.001');
