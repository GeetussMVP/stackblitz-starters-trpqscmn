...
const productData = require('@/app/data/frizai/frizai.json').products;
...
const getStructuredData = (product: any) => {
  const canonicalUrl = `https://www.dekoratoriai.lt/produktai/frizai/${product.code}`;
...
export default async function Page() {
  const product = await getProduct('4.33.202');
