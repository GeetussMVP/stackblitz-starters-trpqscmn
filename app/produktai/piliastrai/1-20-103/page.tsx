...
const productData = require('@/app/data/piliastrai/piliastrai.json').products;
...
const getStructuredData = (product: any) => {
  const canonicalUrl = `https://www.dekoratoriai.lt/produktai/piliastrai/${product.code}`;
...
export default async function Page() {
  const product = await getProduct('1.20.103');
