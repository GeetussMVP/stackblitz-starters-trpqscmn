...
const productData = require('@/app/data/arkiniai-elementai/arkiniai-elementai.json').products;
...
const getStructuredData = (product: any) => {
  const canonicalUrl = `https://www.dekoratoriai.lt/produktai/arkiniai-elementai/${product.code}`;
...
export default async function Page() {
  const product = await getProduct('1.61.511');
