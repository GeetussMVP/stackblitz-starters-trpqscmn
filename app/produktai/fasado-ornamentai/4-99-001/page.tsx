...
const productData = require('@/app/data/fasado-ornamentai/fasado-ornamentai.json').products;
...
const getStructuredData = (product: any) => {
  const canonicalUrl = `https://www.dekoratoriai.lt/produktai/fasado-ornamentai/${product.code}`;
...
export default async function Page() {
  const product = await getProduct('4.99.001');
