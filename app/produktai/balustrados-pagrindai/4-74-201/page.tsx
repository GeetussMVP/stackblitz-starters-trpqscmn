...
const productData = require('@/app/data/balustrados-pagrindai/balustrados-pagrindai.json').products;
...
const getStructuredData = (product: any) => {
  const canonicalUrl = `https://www.dekoratoriai.lt/produktai/balustrados-pagrindai/${product.code}`;
...
export default async function Page() {
  const product = await getProduct('4.74.201');
