...
const productData = require('@/app/data/stulpo-kepure/stulpo-kepure.json').products;
...
const getStructuredData = (product: any) => {
  const canonicalUrl = `https://www.dekoratoriai.lt/produktai/stulpo-kepure/${product.code}`;
...
export default async function Page() {
  const product = await getProduct('4.76.201');
