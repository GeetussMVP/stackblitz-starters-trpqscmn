...
const productData = require('@/app/data/balustrados-porankiai/balustrados-porankiai.json').products;
...
const getStructuredData = (product: any) => {
  const canonicalUrl = `https://www.dekoratoriai.lt/produktai/balustrados-porankiai/${product.code}`;
...
export default async function Page() {
  const product = await getProduct('4.72.101');
