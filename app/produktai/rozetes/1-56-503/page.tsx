...
const productData = require('@/app/data/rozetes/rozetes.json').products;
...
const getStructuredData = (product: any) => {
  const canonicalUrl = `https://www.dekoratoriai.lt/produktai/rozetes/${product.code}`;
...
export default async function Page() {
  const product = await getProduct('1.56.503');
