...
const productData = require('@/app/data/apvadu-kampai/apvadu-kampai.json').products;
...
const getStructuredData = (product: any) => {
  const canonicalUrl = `https://www.dekoratoriai.lt/produktai/apvadu-kampai/${product.code}`;
...
export default async function Page() {
  const product = await getProduct('1.52.308');
