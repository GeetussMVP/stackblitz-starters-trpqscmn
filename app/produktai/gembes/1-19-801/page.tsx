...
const productData = require('@/app/data/gembes/gembes.json').products;
...
const getStructuredData = (product: any) => {
  const canonicalUrl = `https://www.dekoratoriai.lt/produktai/gembes/${product.code}`;
...
export default async function Page() {
  const product = await getProduct('1.19.801');
