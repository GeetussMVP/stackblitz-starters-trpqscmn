...
// app/produktai/gipso-kartono-plokstes/page.tsx
...
export default function GipsoKartonoPlokstesPage() {
  const category: Category = produktaiData[0]; // Gipso kartono plokštės
