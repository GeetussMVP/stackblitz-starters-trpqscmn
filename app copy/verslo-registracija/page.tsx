...
export default function BusinessRegistrationPage() {
  ...
  const handleSubmit = async () => {
    ...
    console.log("Form submitted", { email, companyName, companyCode, passwordLength: password.length, isLogin });
    ...
    try {
      if (isLogin) {
        ...
        // Redirect immediately to business account page
        router.push('/verslo-paskyra');
      } else {
        console.log("Attempting signup...");
        await signup(email, password);
        
        // Save company details to localStorage or your backend
        const businessData = {
          email,
          companyName,
          companyCode,
        ...
        localStorage.setItem('businessAccount', JSON.stringify(businessData));
              ...
              <div className="mt-6 text-center">
                <button
                  onClick={() => {
                    ...
                    setError('');
                    setSuccess('');
                    console.log("Switched mode:", isLogin ? "Signup" : "Login");
                  }}
